	...
	"bootstrap": {
		"fnInit": function(oSettings, nPaging, fnDraw) {
			...
			$(nPaging).addClass('pagination').append(
				'<ul class="pagination">'+
					'<li class="prev disabled"><a href="#"><i class="icon-double-angle-left"></i><span class="hidden-xs">'+oLang.sPrevious+'</span></a></li>'+
					'<li class="next disabled"><a href="#"><span class="hidden-xs">'+oLang.sNext+'</span><i class="icon-double-angle-right"></i></a></li>'+
				'</ul>'
			);
			var els = $('a', nPaging);
...
var ResultSet = new function() {
	...
	return {
		paginate : function(URL, id) {
			if(id == undefined){
				id = '#datatable';
			}

			var data = $(id).dataTable({
		...
		paginateStatic : function(URL, id) {
			if(id == undefined){
				id = '#datatable';
			}
			var data = $(id).dataTable({
