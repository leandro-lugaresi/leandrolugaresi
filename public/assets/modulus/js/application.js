...
$(function () {
    if(window.localStorage.getItem('admin_leftbar_collapse') === 'collapse-leftbar') {
    ...
    $('body').on('click', 'ul.acc-menu a', function() {
        ...
        $.each( LIs, function(i) {
            ...
            if(window.localStorage.getItem('admin_leftbar_collapse') !== 'collapse-leftbar' || $(this).parents('.acc-menu').length > 1) $(LIs[i]).find('ul.acc-menu:visible').slideToggle();
        ...
        if($(this).siblings('ul.acc-menu:visible').length>0)
            ...
            if(window.localStorage.getItem('admin_leftbar_collapse') !== 'collapse-leftbar' || $(this).parents('.acc-menu').length > 1) $(this).siblings('ul.acc-menu').slideToggle({
                duration: 200,
                progress: function(){
                    checkpageheight();
    ...
    $("a#leftmenu-trigger").click(function () {
        if ((window.innerWidth)<768) {
            ...
            if(window.localStorage.getItem('admin_leftbar_collapse') === 'collapse-leftbar') {
                window.localStorage.setItem('admin_leftbar_collapse', '');
                ...
                $('ul.acc-menu:first ul.acc-menu').css('visibility', 'hidden');
                window.localStorage.setItem('admin_leftbar_collapse', 'collapse-leftbar');
            }
        }
        checkpageheight();
        leftbarScrollShow();
    ...
    $("a#rightmenu-trigger").click(function () {
        ...
        if(window.localStorage.getItem('admin_rightbar_show') === 'show-rightbar')
                window.localStorage.setItem('admin_rightbar_show', '');
            else
                window.localStorage.setItem('admin_rightbar_show', 'show-rightbar');
    });
...
$(function () {
    ...
    if(window.localStorage.getItem('theme') != null){
        $("head link#styleswitcher").attr("href", '/assets/modulus/css/variations/' + window.localStorage.getItem('theme'));
    }

    $("#modulus-color-variations a").on('click', function(e){
        $("head link#styleswitcher").attr("href", '/assets/modulus/css/variations/' + $(this).data("theme"));
