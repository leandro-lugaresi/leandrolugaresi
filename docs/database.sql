...
-- Table `pacman`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`user` (
...
-- -----------------------------------------------------
-- Table `pacman`.`acl_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`acl_role` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pacman`.`acl_resource`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`acl_resource` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  `type` CHAR NULL,
...
-- -----------------------------------------------------
-- Table `pacman`.`acl_privilege`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`acl_privilege` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  ...
  CONSTRAINT `fk_acl_privileges_acl_resources1`
    ...
    REFERENCES `pacman`.`acl_resource` (`id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- Table `pacman`.`status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`status` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `pacman`.`type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`type` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(60) NOT NULL,
...
-- -----------------------------------------------------
-- Table `pacman`.`site_content`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`site_content` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_posts_pacman_status1`
    ...
    REFERENCES `pacman`.`status` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_posts_users1`
    FOREIGN KEY (`author_id`)
    REFERENCES `pacman`.`user` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_posts_type1`
    FOREIGN KEY (`type_id`)
    REFERENCES `pacman`.`type` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_site_content_site_content1`
    FOREIGN KEY (`parent_id`)
    REFERENCES `pacman`.`site_content` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pacman`.`user_profile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`user_profile` (
...
-- -----------------------------------------------------
-- Table `pacman`.`metatags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`metatags` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pacman`.`gallery`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`gallery` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `entity` VARCHAR(150) NOT NULL,
  `entity_id` INT NOT NULL,
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `pacman`.`interface`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`interface` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `pacman`.`log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`log` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_log_acl_privilege1`
    ...
    REFERENCES `pacman`.`acl_privilege` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `pacman`.`menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`menu` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pacman`.`itens_menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`itens_menu` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pacman`.`type_menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`type_menu` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  `menu_id` INT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `pacman`.`filetype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`filetype` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `pacman`.`file`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`file` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pacman`.`message_text`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`message_text` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_message_text_interface_text1`
    ...
    REFERENCES `pacman`.`interface` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pacman`.`gallery_itens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`gallery_itens` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `ordem` INT NOT NULL,
  ...
  CONSTRAINT `fk_gallery_has_videos_gallery2`
    ...
    REFERENCES `pacman`.`gallery` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_gallery_itens_file1`
    FOREIGN KEY (`file_id`)
    REFERENCES `pacman`.`file` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pacman`.`acl_role_linker`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`acl_role_linker` (
  `role_id` INT NOT NULL,
  `user_id` INT NOT NULL,
...
-- Table `pacman`.`config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`config` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `pacman`.`template_config`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`template_config` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `entity` VARCHAR(150) NOT NULL,
  `entity_id` INT NOT NULL,
  `config` VARCHAR(200) NOT NULL,
...
-- -----------------------------------------------------
-- Table `pacman`.`products_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`products_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `pacman`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pacman`.`products` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_products_categorys1`
    ...
    REFERENCES `pacman`.`products_category` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
